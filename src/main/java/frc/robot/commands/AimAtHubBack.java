...
public class AimAtHubBack extends Command {
  ...
  public AimAtHubBack(CommandSwerveDrivetrain drivetrain,
  ...
  public void execute() {
    ...
    Rotation2d error = desiredHeading.minus(currentHeading);
    ...
    Rotation2d targetHeading = headingLocked ? lockedHeading : desiredHeading;
